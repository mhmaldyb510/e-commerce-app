...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "addNewCard": MessageLookupByLibrary.simpleMessage("اضافة بطاقة جديده"),
    ...
    "onboardingDetails2": MessageLookupByLibrary.simpleMessage(
      "نقدم لك أفضل المنتجات المتنوعة. اطلع على التفاصيل والصور والتقييمات لتتأكد من اختيار المنتج المثالي",
    ),
